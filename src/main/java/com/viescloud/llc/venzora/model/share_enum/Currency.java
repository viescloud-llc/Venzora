package com.viescloud.llc.venzora.model.share_enum;

import java.util.Map;

import com.viescloud.eco.viesspringutils.util.Enums;
...
public enum Currency {
    ...
    private static final Map<String, Currency> lookup = Enums.mapBy(Currency.values(), v -> v.value);
